...
<div class="page-heading">
  <div class="page-heading-copy">
    ...
    <div>
      ...
      <p class="text-muted mb-0">Số liệu tổng quan về tài khoản trong hệ thống.</p>
    </div>
  </div>
</div>
...
<div class="p-4 rounded bg-body-tertiary">
  <p class="text-muted mb-0">Các biểu đồ chi tiết (doanh thu, đơn hàng theo thời gian...) sẽ được bổ sung ở phiên bản
    tiếp theo.</p>
</div>
