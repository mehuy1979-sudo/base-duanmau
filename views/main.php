 ...
 <header>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="<?= BASE_URL ?>?action=cart" class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti" data-notify="<?= array_sum(array_column($_SESSION['cart'] ?? [], 'quantity')) ?: 0 ?>">
		...
		<div class="wrap-header-mobile">
			...
			<div class="wrap-icon-header flex-w flex-r-m m-r-15">
				...
				<a href="<?= BASE_URL ?>?action=cart" class="icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti" data-notify="<?= array_sum(array_column($_SESSION['cart'] ?? [], 'quantity')) ?: 0 ?>">
					<i class="zmdi zmdi-shopping-cart"></i>
				</a>
