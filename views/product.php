            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35">
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="<?= BASE_URL ?>assets/uploads/<?= htmlspecialchars($product['image'] ?? 'default.jpg') ?>" alt="<?= htmlspecialchars($product['product_name'] ?? $product['name'] ?? 'Sản phẩm') ?>" onerror="this.src='<?= BASE_URL ?>views/images/product-01.jpg'">
