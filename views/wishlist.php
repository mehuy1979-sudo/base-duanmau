...
<body class="animsition">
    ...
    <header class="header-v4">
            ...
            <div class="top-bar">
                <div class="content-topbar flex-sb-m h-full container">
                    ...
                    <div class="right-top-bar flex-w h-full">
                        ...
                        <a href="#" class="flex-c-m trans-04 p-lr-25">Tài khoản của tôi</a>
        ...
        <div class="menu-mobile">
            <ul class="topbar-mobile">
                <li><div class="left-top-bar">Khuyến mại hè giảm 20%</div></li>
            </ul>
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap p-b-25">
                <div>
                    ...
                    <p class="stext-107 cl6 m-t-4">
                        Tất cả các sản phẩm và phân loại bạn đã thả tim lưu lại.
                    </p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-lg-3 p-b-50">
                    ...
                    <ul>
                        <li class="p-b-10"><a href="<?= BASE_URL ?>?action=/product" class="stext-107 cl7 hov-cl1 trans-04">Nữ</a></li>
                        <li class="p-b-10"><a href="<?= BASE_URL ?>?action=/product" class="stext-107 cl7 hov-cl1 trans-04">Nam</a></li>
                        <li class="p-b-10"><a href="<?= BASE_URL ?>?action=/product" class="stext-107 cl7 hov-cl1 trans-04">Giày dép</a></li>
                        <li class="p-b-10"><a href="<?= BASE_URL ?>?action=/product" class="stext-107 cl7 hov-cl1 trans-04">Đồng hồ</a></li>
                    </ul>
                </div>
                <div class="col-sm-6 col-lg-3 p-b-50">
                    ...
                    <ul>
                        ...
                        <li class="p-b-10"><a href="#" class="stext-107 cl7 hov-cl1 trans-04">Đổi trả hàng</a></li>
                        <li class="p-b-10"><a href="#" class="stext-107 cl7 hov-cl1 trans-04">Vận chuyển</a></li>
                        <li class="p-b-10"><a href="#" class="stext-107 cl7 hov-cl1 trans-04">Câu hỏi thường gặp</a></li>
                    </ul>
                </div>
                <div class="col-sm-6 col-lg-3 p-b-50">
                    <h4 class="stext-301 cl0 p-b-30">Liên hệ</h4>
                    <p class="stext-107 cl7 size-201">Địa chỉ: Trịnh Văn Bô, Nam Từ Liêm, Hà Nội.<br>Hotline: 0123 456 789</p>
                </div>
                <div class="col-sm-6 col-lg-3 p-b-50">
                    <h4 class="stext-301 cl0 p-b-30">Bản tin</h4>
                    <form>
                        ...
                        <div class="p-t-18">
                            <button class="flex-c-m stext-101 cl0 size-103 bg1 bor1 hov-btn2 p-lr-15 trans-04">Đăng ký</button>
                        </div>
                    </form>
                </div>
            </div>
            <div class="p-t-40">
                <p class="stext-107 cl6 txt-center">
                    Copyright &copy; <script>document.write(new Date().getFullYear());</script> Bunny Wear. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        function removeFromWishlist(productId, productName) {
            $.ajax({
                url: BASE_URL + '?action=/wishlist&ajax=remove',
                type: 'POST',
        ...
        function clearAllWishlist() {
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        url: BASE_URL + '?action=/wishlist&ajax=clear',
                        type: 'POST',
                        dataType: 'json',
                        success: function(res) {
                            if (res.success) {
